    ...
    protected void configure(HttpSecurity http) throws Exception {
         ...
         .authorizeRequests()
             .antMatchers("/",
                 ...
                 "/**/*.js")
                 .permitAll()
             .antMatchers("/vacations/**","/api/auth/**")
                 .permitAll()
             .antMatchers("/api/user/checkUsernameAvailability", "/api/user/checkEmailAvailability","/vacations/**")
                 .permitAll()
             .antMatchers(HttpMethod.GET, "/api/polls/**", "/api/users/**","/vacations/**")
                 .permitAll()
             .anyRequest()
                 .authenticated();
//  
